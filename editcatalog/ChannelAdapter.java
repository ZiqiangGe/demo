...
/**
 * Created by yujibo on 2019/3/21.
 */
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener
{
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper, List<ChannelEntity> mMyChannelItems, List<ChannelEntity> mOtherChannelItems,Activity dialog) {
...
//                        if (mContext != null && mContext.isShowing()) {
//                            mContext.dismiss();
//                            /**
//                             *   如果没有点击完成，默认切换
//                             */
